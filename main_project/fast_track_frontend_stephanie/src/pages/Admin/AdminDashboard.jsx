...
// Recent request row
const RecentRequestRow = ({ requestNumber, requesterName, docType, statusLabel, statusColor }) => (
  <div
  ...
  return (
    <AdminLayout>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-700 text-sm">Real-time summary of FAST Track system activity</p>
      </div>
