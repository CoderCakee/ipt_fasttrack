...
export default function RequestDocumentStep3() {
  ...
  useEffect(() => {
    if (!location.state || !location.state.personalInfo || !location.state.documents) {
      // Optionally redirect or handle missing state here
    }
  ...
  return (
    <div className="min-h-screen relative flex flex-col bg-[#2C3E9E] font-sans">
      ...
      <div className="relative z-10 px-4 pb-10 mt-16">
        <main className="max-w-3xl w-full mx-auto bg-white rounded-lg shadow-lg p-10">
          ...
          <section className="border border-gray-300 rounded-lg p-6 mb-6">
            ...
            <p className="text-gray-600 text-sm mb-6">Please verify all information</p>
            ...
            <div className="mt-4 flex items-center space-x-2 bg-[#E6EEF9] rounded border border-[#A6D0F5] px-4 py-2 text-sm text-[#3C6FC4]">
              ...
              <p className="flex-1">
                Processing usually takes 3–5 working days. You will receive an email
                with payment instructions and your request number.
              </p>
            </div>
            ...
            <label className="flex items-start space-x-3 mt-4">
              ...
              <span className="text-sm text-gray-700">
                I understand that all personal information provided will be used solely
                for processing my document request in compliance with the Data Privacy Act.
              </span>
            </label>
